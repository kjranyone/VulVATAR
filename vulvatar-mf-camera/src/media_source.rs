...
use windows::Win32::Media::MediaFoundation::{
    ...
    MFVideoInterlace_Progressive, MFVideoPrimaries_BT709, MFVideoTransFunc_sRGB,
    MEDIA_EVENT_GENERATOR_GET_EVENT_FLAGS, MFMEDIASOURCE_CHARACTERISTICS, MFMEDIASOURCE_IS_LIVE,
    MF_CAPTURE_ENGINE_MEDIASOURCE, MF_DEVICEMFT_SENSORPROFILE_COLLECTION,
