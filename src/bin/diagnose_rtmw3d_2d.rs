//! RTMW3D raw 2D keypoint overlay. Runs the production provider over a
//! frame directory, draws COCO-Wholebody 2D keypoints (green=score>0.5,
//! yellow>0.3, red=low), and reports detection confidence.
//!
