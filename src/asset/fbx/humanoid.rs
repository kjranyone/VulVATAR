...
pub fn map_bone_name(raw_name: &str) -> Option<HumanoidBone> {
    ...
    match norm.as_str() {
        ...
        "lefthand" | "hand_l" | "l_hand" | "left_hand" | "wrist_l" => Some(HumanoidBone::LeftHand),
        ...
        "leftfoot" | "foot_l" | "l_foot" | "left_foot" | "ankle_l" => Some(HumanoidBone::LeftFoot),
        ...
        // Left fingers - Thumb
        "thumbproximal_l" | "thumb_proximal_l" | "thumb_01_l" | "thumb1_l"
        | "leftthumbproximal" | "lefthandthumb1" => Some(HumanoidBone::LeftThumbProximal),
        "thumbintermediate_l"
        | "thumb_intermediate_l"
        | "thumb_02_l"
        | "thumb2_l"
        | "leftthumbintermediate"
        | "lefthandthumb2" => Some(HumanoidBone::LeftThumbIntermediate),
        "thumbdistal_l" | "thumb_distal_l" | "thumb_03_l" | "thumb3_l" | "leftthumbdistal"
        | "lefthandthumb3" => Some(HumanoidBone::LeftThumbDistal),

        // Left fingers - Index
        "indexproximal_l" | "index_proximal_l" | "index_01_l" | "index1_l"
        | "leftindexproximal" | "lefthandindex1" => Some(HumanoidBone::LeftIndexProximal),
        "indexintermediate_l"
        | "index_intermediate_l"
        | "index_02_l"
        | "index2_l"
        | "leftindexintermediate"
        | "lefthandindex2" => Some(HumanoidBone::LeftIndexIntermediate),
        ...
        | "lefthandmiddle2" => Some(HumanoidBone::LeftMiddleIntermediate),
        ...
        | "lefthandring2" => Some(HumanoidBone::LeftRingIntermediate),
        ...
        | "pinkyintermediate_l"
        | "pinky_02_l"
        | "lefthandpinky2" => Some(HumanoidBone::LeftLittleIntermediate),
        ...
        // Right fingers - Thumb
        "thumbproximal_r" | "thumb_proximal_r" | "thumb_01_r" | "thumb1_r"
        | "rightthumbproximal" | "righthandthumb1" => Some(HumanoidBone::RightThumbProximal),
        "thumbintermediate_r"
        | "thumb_intermediate_r"
        | "thumb_02_r"
        | "thumb2_r"
        | "rightthumbintermediate"
        | "righthandthumb2" => Some(HumanoidBone::RightThumbIntermediate),
        "thumbdistal_r" | "thumb_distal_r" | "thumb_03_r" | "thumb3_r" | "rightthumbdistal"
        | "righthandthumb3" => Some(HumanoidBone::RightThumbDistal),

        // Right fingers - Index
        "indexproximal_r" | "index_proximal_r" | "index_01_r" | "index1_r"
        | "rightindexproximal" | "righthandindex1" => Some(HumanoidBone::RightIndexProximal),
        "indexintermediate_r"
        | "index_intermediate_r"
        | "index_02_r"
        | "index2_r"
        | "rightindexintermediate"
        | "righthandindex2" => Some(HumanoidBone::RightIndexIntermediate),
        ...
        | "middle1_r"
        | "rightmiddleproximal"
        | "righthandmiddle1" => Some(HumanoidBone::RightMiddleProximal),
        "middleintermediate_r"
        | "middle_intermediate_r"
        | "middle_02_r"
        | "middle2_r"
        | "rightmiddleintermediate"
        | "righthandmiddle2" => Some(HumanoidBone::RightMiddleIntermediate),
        ...
        | "righthandring2" => Some(HumanoidBone::RightRingIntermediate),
        ...
        | "pinkyproximal_r"
        | "pinky_01_r"
        | "righthandpinky1" => Some(HumanoidBone::RightLittleProximal),
        ...
        | "pinkyintermediate_r"
        | "pinky_02_r"
        | "righthandpinky2" => Some(HumanoidBone::RightLittleIntermediate),
