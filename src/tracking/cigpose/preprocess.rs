//! 288×384 NCHW resize + ImageNet normalize for CIGPose.
//!
//! Pure-function bilinear resampling, mirrors the algorithm in
//! `rtmw3d::preprocess::preprocess`. Aspect is squashed (no letterbox)
//! — the model is robust to it for centred-subject inputs.
