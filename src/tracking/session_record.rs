...
use super::source_skeleton::{JointOrigin, SourceSkeleton};
...
fn origin_tag(o: JointOrigin) -> &'static str {
    match o {
        JointOrigin::Observed => "O",
        JointOrigin::Extrapolated => "E",
        JointOrigin::Synthesized => "S",
    }
}
