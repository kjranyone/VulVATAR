//! 192×256 NCHW resize + ImageNet normalize for ViTPose.
//!
//! Same OpenCV-style bilinear pixel-centre sampling as
//! `rtmw3d::preprocess::preprocess`, just at ViTPose's input
//! resolution. The caller is expected to feed a YOLOX-bbox-padded
//! crop whose aspect is close to 3:4 so the squash is minimal.
