...
pub type rs2_notification_category = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub type rs2_exception_type = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub type rs2_distortion = ::std::os::raw::c_int;
unsafe extern "C" {
...
const _: () = {
    ["Size of rs2_intrinsics"][::std::mem::size_of::<rs2_intrinsics>() - 48usize];
    ["Alignment of rs2_intrinsics"][::std::mem::align_of::<rs2_intrinsics>() - 4usize];
    ["Offset of field: rs2_intrinsics::width"]
        [::std::mem::offset_of!(rs2_intrinsics, width) - 0usize];
    ["Offset of field: rs2_intrinsics::height"]
        [::std::mem::offset_of!(rs2_intrinsics, height) - 4usize];
    ["Offset of field: rs2_intrinsics::ppx"][::std::mem::offset_of!(rs2_intrinsics, ppx) - 8usize];
    ["Offset of field: rs2_intrinsics::ppy"][::std::mem::offset_of!(rs2_intrinsics, ppy) - 12usize];
    ["Offset of field: rs2_intrinsics::fx"][::std::mem::offset_of!(rs2_intrinsics, fx) - 16usize];
    ["Offset of field: rs2_intrinsics::fy"][::std::mem::offset_of!(rs2_intrinsics, fy) - 20usize];
    ["Offset of field: rs2_intrinsics::model"]
        [::std::mem::offset_of!(rs2_intrinsics, model) - 24usize];
    ["Offset of field: rs2_intrinsics::coeffs"]
        [::std::mem::offset_of!(rs2_intrinsics, coeffs) - 28usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_motion_device_intrinsic"]
        [::std::mem::size_of::<rs2_motion_device_intrinsic>() - 72usize];
    ["Alignment of rs2_motion_device_intrinsic"]
        [::std::mem::align_of::<rs2_motion_device_intrinsic>() - 4usize];
    ["Offset of field: rs2_motion_device_intrinsic::data"]
        [::std::mem::offset_of!(rs2_motion_device_intrinsic, data) - 0usize];
    ["Offset of field: rs2_motion_device_intrinsic::noise_variances"]
        [::std::mem::offset_of!(rs2_motion_device_intrinsic, noise_variances) - 48usize];
    ["Offset of field: rs2_motion_device_intrinsic::bias_variances"]
        [::std::mem::offset_of!(rs2_motion_device_intrinsic, bias_variances) - 60usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_vertex"][::std::mem::size_of::<rs2_vertex>() - 12usize];
    ["Alignment of rs2_vertex"][::std::mem::align_of::<rs2_vertex>() - 4usize];
    ["Offset of field: rs2_vertex::xyz"][::std::mem::offset_of!(rs2_vertex, xyz) - 0usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_pixel"][::std::mem::size_of::<rs2_pixel>() - 8usize];
    ["Alignment of rs2_pixel"][::std::mem::align_of::<rs2_pixel>() - 4usize];
    ["Offset of field: rs2_pixel::ij"][::std::mem::offset_of!(rs2_pixel, ij) - 0usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_vector"][::std::mem::size_of::<rs2_vector>() - 12usize];
    ["Alignment of rs2_vector"][::std::mem::align_of::<rs2_vector>() - 4usize];
    ["Offset of field: rs2_vector::x"][::std::mem::offset_of!(rs2_vector, x) - 0usize];
    ["Offset of field: rs2_vector::y"][::std::mem::offset_of!(rs2_vector, y) - 4usize];
    ["Offset of field: rs2_vector::z"][::std::mem::offset_of!(rs2_vector, z) - 8usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_quaternion"][::std::mem::size_of::<rs2_quaternion>() - 16usize];
    ["Alignment of rs2_quaternion"][::std::mem::align_of::<rs2_quaternion>() - 4usize];
    ["Offset of field: rs2_quaternion::x"][::std::mem::offset_of!(rs2_quaternion, x) - 0usize];
    ["Offset of field: rs2_quaternion::y"][::std::mem::offset_of!(rs2_quaternion, y) - 4usize];
    ["Offset of field: rs2_quaternion::z"][::std::mem::offset_of!(rs2_quaternion, z) - 8usize];
    ["Offset of field: rs2_quaternion::w"][::std::mem::offset_of!(rs2_quaternion, w) - 12usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rs2_pose {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_pose"][::std::mem::size_of::<rs2_pose>() - 84usize];
    ["Alignment of rs2_pose"][::std::mem::align_of::<rs2_pose>() - 4usize];
    ["Offset of field: rs2_pose::translation"]
        [::std::mem::offset_of!(rs2_pose, translation) - 0usize];
    ["Offset of field: rs2_pose::velocity"][::std::mem::offset_of!(rs2_pose, velocity) - 12usize];
    ["Offset of field: rs2_pose::acceleration"]
        [::std::mem::offset_of!(rs2_pose, acceleration) - 24usize];
    ["Offset of field: rs2_pose::rotation"][::std::mem::offset_of!(rs2_pose, rotation) - 36usize];
    ["Offset of field: rs2_pose::angular_velocity"]
        [::std::mem::offset_of!(rs2_pose, angular_velocity) - 52usize];
    ["Offset of field: rs2_pose::angular_acceleration"]
        [::std::mem::offset_of!(rs2_pose, angular_acceleration) - 64usize];
    ["Offset of field: rs2_pose::tracker_confidence"]
        [::std::mem::offset_of!(rs2_pose, tracker_confidence) - 76usize];
    ["Offset of field: rs2_pose::mapper_confidence"]
        [::std::mem::offset_of!(rs2_pose, mapper_confidence) - 80usize];
};
#[doc = " \\brief Object detection result from algorithm"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rs2_object_detection {
    #[doc = "< Object class/category identifier"]
    pub class_id: ::std::os::raw::c_int,
    #[doc = "< Detection confidence score 0-100"]
    pub score: ::std::os::raw::c_int,
    #[doc = "< Top-left corner pixel X coordinate"]
    pub top_left_x: ::std::os::raw::c_int,
    #[doc = "< Top-left corner pixel Y coordinate"]
    pub top_left_y: ::std::os::raw::c_int,
    #[doc = "< Bottom-right corner pixel X coordinate"]
    pub bottom_right_x: ::std::os::raw::c_int,
    #[doc = "< Bottom-right corner pixel Y coordinate"]
    pub bottom_right_y: ::std::os::raw::c_int,
    #[doc = "< Mean depth in meters at detection location"]
    pub depth: f32,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_object_detection"][::std::mem::size_of::<rs2_object_detection>() - 28usize];
    ["Alignment of rs2_object_detection"][::std::mem::align_of::<rs2_object_detection>() - 4usize];
    ["Offset of field: rs2_object_detection::class_id"]
        [::std::mem::offset_of!(rs2_object_detection, class_id) - 0usize];
    ["Offset of field: rs2_object_detection::score"]
        [::std::mem::offset_of!(rs2_object_detection, score) - 4usize];
    ["Offset of field: rs2_object_detection::top_left_x"]
        [::std::mem::offset_of!(rs2_object_detection, top_left_x) - 8usize];
    ["Offset of field: rs2_object_detection::top_left_y"]
        [::std::mem::offset_of!(rs2_object_detection, top_left_y) - 12usize];
    ["Offset of field: rs2_object_detection::bottom_right_x"]
        [::std::mem::offset_of!(rs2_object_detection, bottom_right_x) - 16usize];
    ["Offset of field: rs2_object_detection::bottom_right_y"]
        [::std::mem::offset_of!(rs2_object_detection, bottom_right_y) - 20usize];
    ["Offset of field: rs2_object_detection::depth"]
        [::std::mem::offset_of!(rs2_object_detection, depth) - 24usize];
};
...
pub type rs2_log_severity = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub const rs2_extension_RS2_EXTENSION_ROTATION_FILTER: rs2_extension = 56;
pub const rs2_extension_RS2_EXTENSION_SAFETY_SENSOR: rs2_extension = 57;
pub const rs2_extension_RS2_EXTENSION_DEPTH_MAPPING_SENSOR: rs2_extension = 58;
pub const rs2_extension_RS2_EXTENSION_LABELED_POINTS: rs2_extension = 59;
pub const rs2_extension_RS2_EXTENSION_ETH_CONFIG: rs2_extension = 60;
pub const rs2_extension_RS2_EXTENSION_SUPPORTED_EMBEDDED_FILTERS: rs2_extension = 61;
pub const rs2_extension_RS2_EXTENSION_DECIMATION_EMBEDDED_FILTER: rs2_extension = 62;
pub const rs2_extension_RS2_EXTENSION_TEMPORAL_EMBEDDED_FILTER: rs2_extension = 63;
pub const rs2_extension_RS2_EXTENSION_INFERENCE_FRAME: rs2_extension = 64;
pub const rs2_extension_RS2_EXTENSION_OBJECT_DETECTION_FRAME: rs2_extension = 65;
pub const rs2_extension_RS2_EXTENSION_INFERENCE_SENSOR: rs2_extension = 66;
pub const rs2_extension_RS2_EXTENSION_OBJECT_DETECTION_SENSOR: rs2_extension = 67;
pub const rs2_extension_RS2_EXTENSION_INFERENCE_PROFILE: rs2_extension = 68;
pub const rs2_extension_RS2_EXTENSION_COUNT: rs2_extension = 69;
#[doc = " \\brief Specifies advanced interfaces (capabilities) objects may implement."]
pub type rs2_extension = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub type rs2_matchers = ::std::os::raw::c_int;
unsafe extern "C" {
    pub fn rs2_matchers_to_string(stream: rs2_matchers) -> *const ::std::os::raw::c_char;
}
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_UNKNOWN: rs2_point_cloud_label = 0;
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_UNDEFINED: rs2_point_cloud_label = 1;
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_INVALID: rs2_point_cloud_label = 2;
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_GROUND: rs2_point_cloud_label = 3;
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_NEAR_GROUND: rs2_point_cloud_label = 4;
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_OVERHEAD: rs2_point_cloud_label = 5;
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_ABOVE_CEILING_HEIGHT: rs2_point_cloud_label =
    6;
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_GAP: rs2_point_cloud_label = 7;
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_MASKED: rs2_point_cloud_label = 8;
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_CLIFF: rs2_point_cloud_label = 9;
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_OBSTACLE: rs2_point_cloud_label = 10;
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_OBSTACLE_DANGER: rs2_point_cloud_label = 11;
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_OBSTACLE_WARNING: rs2_point_cloud_label = 12;
pub const rs2_point_cloud_label_RS2_POINT_CLOUD_LABEL_COUNT: rs2_point_cloud_label = 13;
pub type rs2_point_cloud_label = ::std::os::raw::c_int;
unsafe extern "C" {
    pub fn rs2_point_cloud_label_to_string(
        label: rs2_point_cloud_label,
    ) -> *const ::std::os::raw::c_char;
}
pub const rs2_calib_location_RS2_CALIB_LOCATION_FIRST: rs2_calib_location = 0;
pub const rs2_calib_location_RS2_CALIB_LOCATION_EEPROM: rs2_calib_location = 0;
pub const rs2_calib_location_RS2_CALIB_LOCATION_FLASH: rs2_calib_location = 1;
pub const rs2_calib_location_RS2_CALIB_LOCATION_RAM: rs2_calib_location = 2;
pub const rs2_calib_location_RS2_CALIB_LOCATION_COUNT: rs2_calib_location = 3;
pub type rs2_calib_location = ::std::os::raw::c_int;
unsafe extern "C" {
    pub fn rs2_calib_location_to_string(
        calib_location: rs2_calib_location,
    ) -> *const ::std::os::raw::c_char;
}
pub const rs2_embedded_filter_type_RS2_EMBEDDED_FILTER_TYPE_FIRST: rs2_embedded_filter_type = 0;
pub const rs2_embedded_filter_type_RS2_EMBEDDED_FILTER_TYPE_DECIMATION: rs2_embedded_filter_type =
    0;
pub const rs2_embedded_filter_type_RS2_EMBEDDED_FILTER_TYPE_TEMPORAL: rs2_embedded_filter_type = 1;
pub const rs2_embedded_filter_type_RS2_EMBEDDED_FILTER_TYPE_COUNT: rs2_embedded_filter_type = 2;
pub type rs2_embedded_filter_type = ::std::os::raw::c_int;
unsafe extern "C" {
    pub fn rs2_embedded_filter_type_to_string(
        embedded_filter: rs2_embedded_filter_type,
    ) -> *const ::std::os::raw::c_char;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rs2_embedded_filter {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rs2_embedded_filter_list {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = "< Connection type, for example USB, GMSL, DDS"]
pub const rs2_camera_info_RS2_CAMERA_INFO_CONNECTION_TYPE: rs2_camera_info = 15;
#[doc = "< Safety MCU FW Version"]
pub const rs2_camera_info_RS2_CAMERA_INFO_SMCU_FW_VERSION: rs2_camera_info = 16;
#[doc = "< IMU Type"]
pub const rs2_camera_info_RS2_CAMERA_INFO_IMU_TYPE: rs2_camera_info = 17;
#[doc = "< MIPI driver version (Jetson platform only)"]
pub const rs2_camera_info_RS2_CAMERA_INFO_MIPI_DRIVER_VERSION: rs2_camera_info = 18;
#[doc = "< Number of enumeration values. Not a valid input: intended to be used in for-loops."]
pub const rs2_camera_info_RS2_CAMERA_INFO_COUNT: rs2_camera_info = 19;
...
pub type rs2_camera_info = ::std::os::raw::c_int;
unsafe extern "C" {
...
#[doc = "< safety info"]
pub const rs2_stream_RS2_STREAM_SAFETY: rs2_stream = 11;
#[doc = "< occupancy info"]
pub const rs2_stream_RS2_STREAM_OCCUPANCY: rs2_stream = 12;
#[doc = "< labeled point cloud stream"]
pub const rs2_stream_RS2_STREAM_LABELED_POINT_CLOUD: rs2_stream = 13;
#[doc = "< object detection stream"]
pub const rs2_stream_RS2_STREAM_OBJECT_DETECTION: rs2_stream = 14;
pub const rs2_stream_RS2_STREAM_COUNT: rs2_stream = 15;
#[doc = " \\brief Streams are different types of data provided by RealSense devices."]
pub type rs2_stream = ::std::os::raw::c_int;
unsafe extern "C" {
...
#[doc = "< Semi-planar YUV 4:2:0: full-resolution Y plane followed by interleaved half-resolution U,V plane. 12 bits per pixel."]
pub const rs2_format_RS2_FORMAT_NV12: rs2_format = 34;
#[doc = "< Number of enumeration values. Not a valid input: intended to be used in for-loops."]
pub const rs2_format_RS2_FORMAT_COUNT: rs2_format = 35;
#[doc = " \\brief A stream's format identifies how binary data is encoded within a frame."]
pub type rs2_format = ::std::os::raw::c_int;
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_extrinsics"][::std::mem::size_of::<rs2_extrinsics>() - 48usize];
    ["Alignment of rs2_extrinsics"][::std::mem::align_of::<rs2_extrinsics>() - 4usize];
    ["Offset of field: rs2_extrinsics::rotation"]
        [::std::mem::offset_of!(rs2_extrinsics, rotation) - 0usize];
    ["Offset of field: rs2_extrinsics::translation"]
        [::std::mem::offset_of!(rs2_extrinsics, translation) - 36usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_combined_motion__bindgen_ty_1"]
        [::std::mem::size_of::<rs2_combined_motion__bindgen_ty_1>() - 32usize];
    ["Alignment of rs2_combined_motion__bindgen_ty_1"]
        [::std::mem::align_of::<rs2_combined_motion__bindgen_ty_1>() - 8usize];
    ["Offset of field: rs2_combined_motion__bindgen_ty_1::x"]
        [::std::mem::offset_of!(rs2_combined_motion__bindgen_ty_1, x) - 0usize];
    ["Offset of field: rs2_combined_motion__bindgen_ty_1::y"]
        [::std::mem::offset_of!(rs2_combined_motion__bindgen_ty_1, y) - 8usize];
    ["Offset of field: rs2_combined_motion__bindgen_ty_1::z"]
        [::std::mem::offset_of!(rs2_combined_motion__bindgen_ty_1, z) - 16usize];
    ["Offset of field: rs2_combined_motion__bindgen_ty_1::w"]
        [::std::mem::offset_of!(rs2_combined_motion__bindgen_ty_1, w) - 24usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_combined_motion__bindgen_ty_2"]
        [::std::mem::size_of::<rs2_combined_motion__bindgen_ty_2>() - 24usize];
    ["Alignment of rs2_combined_motion__bindgen_ty_2"]
        [::std::mem::align_of::<rs2_combined_motion__bindgen_ty_2>() - 8usize];
    ["Offset of field: rs2_combined_motion__bindgen_ty_2::x"]
        [::std::mem::offset_of!(rs2_combined_motion__bindgen_ty_2, x) - 0usize];
    ["Offset of field: rs2_combined_motion__bindgen_ty_2::y"]
        [::std::mem::offset_of!(rs2_combined_motion__bindgen_ty_2, y) - 8usize];
    ["Offset of field: rs2_combined_motion__bindgen_ty_2::z"]
        [::std::mem::offset_of!(rs2_combined_motion__bindgen_ty_2, z) - 16usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_combined_motion__bindgen_ty_3"]
        [::std::mem::size_of::<rs2_combined_motion__bindgen_ty_3>() - 24usize];
    ["Alignment of rs2_combined_motion__bindgen_ty_3"]
        [::std::mem::align_of::<rs2_combined_motion__bindgen_ty_3>() - 8usize];
    ["Offset of field: rs2_combined_motion__bindgen_ty_3::x"]
        [::std::mem::offset_of!(rs2_combined_motion__bindgen_ty_3, x) - 0usize];
    ["Offset of field: rs2_combined_motion__bindgen_ty_3::y"]
        [::std::mem::offset_of!(rs2_combined_motion__bindgen_ty_3, y) - 8usize];
    ["Offset of field: rs2_combined_motion__bindgen_ty_3::z"]
        [::std::mem::offset_of!(rs2_combined_motion__bindgen_ty_3, z) - 16usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_combined_motion"][::std::mem::size_of::<rs2_combined_motion>() - 80usize];
    ["Alignment of rs2_combined_motion"][::std::mem::align_of::<rs2_combined_motion>() - 8usize];
    ["Offset of field: rs2_combined_motion::orientation"]
        [::std::mem::offset_of!(rs2_combined_motion, orientation) - 0usize];
    ["Offset of field: rs2_combined_motion::angular_velocity"]
        [::std::mem::offset_of!(rs2_combined_motion, angular_velocity) - 32usize];
    ["Offset of field: rs2_combined_motion::linear_acceleration"]
        [::std::mem::offset_of!(rs2_combined_motion, linear_acceleration) - 56usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = " create a static snapshot of all embedded filters within a specific sensor.\n \\param[in]  sensor    specific RealSense sensor\n \\param[out] error     if non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return               the list of embedded filters, should be released by rs2_delete_embeddded_filter_list"]
    pub fn rs2_query_embedded_filters(
        sensor: *const rs2_sensor,
        error: *mut *mut rs2_error,
    ) -> *mut rs2_embedded_filter_list;
}
unsafe extern "C" {
    #[doc = " delete embedded filter list allocated by rs2_query_embedded_filters\n \\param[in] embedded_filter_list       embedded filter list to delete"]
    pub fn rs2_delete_embedded_filter_list(embedded_filter_list: *mut rs2_embedded_filter_list);
}
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = " Check if a camera is in recovery mode\n \\param[in]  device    The RealSense device to check\n \\param[out] error     If non-null, receives any error that occurs during this call, otherwise, errors are ignored"]
    pub fn rs2_is_in_recovery_mode(
        device: *const rs2_device,
        error: *mut *mut rs2_error,
    ) -> ::std::os::raw::c_int;
}
...
pub type rs2_calibration_type = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub type rs2_timestamp_domain = ::std::os::raw::c_int;
unsafe extern "C" {
...
#[doc = "< Color image white balance. Manual WB value on D400, current WB value on D585S"]
...
#[doc = "< Counter of the depth frame upon which the stream was calculated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_DEPTH_FRAME_COUNTER:
    rs2_frame_metadata_value = 43;
#[doc = "< Designates the Yellow zone status: 0x1 - High, 0x0 - Low"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_LEVEL1: rs2_frame_metadata_value = 44;
#[doc = "< When l1 is low - equals to frame_counter in safety_header - For l1=0x1 : hold the Frame id on last transition to \"High\" state"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_LEVEL1_ORIGIN:
    rs2_frame_metadata_value = 45;
#[doc = "< Designates the \"Red\" zone status: 0x1 - High, 0x0 - Low"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_LEVEL2: rs2_frame_metadata_value = 46;
#[doc = "< When l2 is low - equals to frame_counter in safety_header - For l2=0x1 : hold the Frame id on last transition to \"High\" state"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_LEVEL2_ORIGIN:
    rs2_frame_metadata_value = 47;
#[doc = "< Current verdict for l1 Safety Signal - May differ from l1_signal due to additional logics applied"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_LEVEL1_VERDICT:
    rs2_frame_metadata_value = 48;
#[doc = "< Current verdict for l2 Safety Signal - May differ from l2_signal due to additional logics applied"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_LEVEL2_VERDICT:
    rs2_frame_metadata_value = 49;
#[doc = "< Reflects the SC operational mode (XU control)"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_OPERATIONAL_MODE:
    rs2_frame_metadata_value = 50;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_VISION_VERDICT:
    rs2_frame_metadata_value = 51;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_HARA_EVENTS: rs2_frame_metadata_value =
    52;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_PRESET_INTEGRITY:
    rs2_frame_metadata_value = 53;
#[doc = "< Safety Preset index set via Adaptive Field selection GPIO"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_PRESET_ID_SELECTED:
    rs2_frame_metadata_value = 54;
#[doc = "< Safety Preset index used in the latest Vision Safety algo processing"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_PRESET_ID_USED:
    rs2_frame_metadata_value = 55;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SIP_DEGRADATION_USED:
    rs2_frame_metadata_value = 56;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SIP_GENERIC_METRICS_ACTIVATE:
    rs2_frame_metadata_value = 57;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SIP_GENERIC_METRICS_STATE:
    rs2_frame_metadata_value = 58;
#[doc = "< First value from byte array of up to 8 Generic Safety Algo continuous metrics indications"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SIP_GENERIC_METRICS_VALUE1:
    rs2_frame_metadata_value = 59;
#[doc = "< Second value from byte array of up to 8 Generic Safety Algo continuous metrics indications"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SIP_GENERIC_METRICS_VALUE2:
    rs2_frame_metadata_value = 60;
#[doc = "< First value from byte array of up to 8 Generic Safety Algo continuous metrics thresholds"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SIP_GENERIC_METRICS_THRESHOLD1:
    rs2_frame_metadata_value = 61;
#[doc = "< Second value from byte array of up to 8 Generic Safety Algo continuous metrics thresholds"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SIP_GENERIC_METRICS_THRESHOLD2:
    rs2_frame_metadata_value = 62;
#[doc = "< Enum - 0:Regular (default) all safety in nominal mode - 1: \"Zero Safety\" mode"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_ZERO_MONITORING_ENABLED:
    rs2_frame_metadata_value = 63;
#[doc = "< Enum - 0:Regular - 1: No history - 2: Local history"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_HARA_HISTORY_MODE:
    rs2_frame_metadata_value = 64;
#[doc = "< Bitmask, enumerated - SOC critical notification: L2/L3 that requires handling/troubleshooting in S.MCU 32-bit value, as supplied by STL mechanism"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SOC_FUSA_EVENTS:
    rs2_frame_metadata_value = 65;
#[doc = "< Bitmask, enumerated - Action taken. 0x1 << 0  - HKR Reset, 0x1 << 1  - HKR ShutDown"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SOC_FUSA_ACTION:
    rs2_frame_metadata_value = 66;
#[doc = "< Total number of L0 notifications captured"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SOC_L0_COUNTER:
    rs2_frame_metadata_value = 67;
#[doc = "< L_0 notifications per FDTI"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SOC_L0_RATE: rs2_frame_metadata_value =
    68;
#[doc = "< Total number of L1 notifications captured"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SOC_L1_COUNTER:
    rs2_frame_metadata_value = 69;
#[doc = "< L_1 notifications per FDTI"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SOC_L1_RATE: rs2_frame_metadata_value =
    70;
#[doc = "< Result, enumerated: 0 - GMT Clock Ok, 1- GMT Clock is outside Safe threshold, 2 - GMT Clock is not available"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SOC_GMT_STATUS:
    rs2_frame_metadata_value = 71;
#[doc = "< Critical-erro GPIO Status: 0 - off, 1 - on"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SOC_HKR_CRITICAL_ERROR_GPIO:
    rs2_frame_metadata_value = 72;
#[doc = "< Soc Monitor Escalation of L2 error to Arbiter"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SOC_MONITOR_L2_ERROR_TYPE:
    rs2_frame_metadata_value = 73;
#[doc = "< Soc Monitor Escalation of L3 error to Arbiter"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SOC_MONITOR_L3_ERROR_TYPE:
    rs2_frame_metadata_value = 74;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SOC_SAFETY_AND_SECURITY:
    rs2_frame_metadata_value = 75;
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_DEPTH_FRAME_TIMESTAMP:
    rs2_frame_metadata_value = 76;
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SMCU_PROCESSING_TIMESTAMP:
    rs2_frame_metadata_value = 77;
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_PIPELINE_PROPAGATION_DELAY:
    rs2_frame_metadata_value = 78;
#[doc = "< Bitmask: The values are state-specific and non-FuSa related. Shall be presented as HEX string"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SMCU_DEBUG_STATUS_BITMASK:
    rs2_frame_metadata_value = 79;
#[doc = "< Enumerated: according to S.MCU FSM"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SMCU_DEBUG_INFO_INTERNAL_STATE:
    rs2_frame_metadata_value = 80;
#[doc = "< Bitmask. To be presented as HEX value"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SMCU_DEBUG_INFO_BIST_STATUS:
    rs2_frame_metadata_value = 81;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_NON_FUSA_GPIO_OUT:
    rs2_frame_metadata_value = 82;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SMCU_HW_MONITOR_STATUS:
    rs2_frame_metadata_value = 83;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SMCU_SW_MONITOR_STATUS:
    rs2_frame_metadata_value = 84;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_NON_FUSA_GPIO_IN:
    rs2_frame_metadata_value = 85;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_MB_FUSA_EVENT:
    rs2_frame_metadata_value = 86;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_MB_FUSA_ACTION:
    rs2_frame_metadata_value = 87;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_MB_STATUS: rs2_frame_metadata_value =
    88;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SMCU_LIVELINESS:
    rs2_frame_metadata_value = 89;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_SMCU_STATE: rs2_frame_metadata_value =
    90;
#[doc = "< Designates the Safety Zone index in [0..63] range used in algo pipe"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_PRESET_ID: rs2_frame_metadata_value =
    91;
#[doc = "< In millidegrees. Relative to X (forward) axis. Positive value is CCW"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SENSOR_ANGLE_ROLL: rs2_frame_metadata_value =
    92;
#[doc = "< In millidegrees. Relative to Y (left) axis. Positive value is CCW"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SENSOR_ANGLE_PITCH: rs2_frame_metadata_value =
    93;
#[doc = "< In millimeters. Relative to the \"leveled pointcloud\" CS"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DIAGNOSTIC_ZONE_MEDIAN_HEIGHT:
    rs2_frame_metadata_value = 94;
#[doc = "< Percentage"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_FLOOR_DETECTION: rs2_frame_metadata_value =
    95;
#[doc = "< Percentage"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DIAGNOSTIC_ZONE_FILL_RATE:
    rs2_frame_metadata_value = 96;
#[doc = "< Unsigned value in range of [0..100]. Use [x = 0xFF] if not applicable"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DEPTH_FILL_RATE: rs2_frame_metadata_value =
    97;
#[doc = "< Spatial accuracy in millimetric units"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DEPTH_STDEV: rs2_frame_metadata_value = 98;
#[doc = "< Number of rows in the grid. Max value is 250 (corresponding to 5M width with 2cm tile)"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_OCCUPANCY_GRID_ROWS:
    rs2_frame_metadata_value = 99;
#[doc = "< Number of columns in the grid. Max value is 320 (corresponding to ~6.5M depth with 2cm tile)"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_OCCUPANCY_GRID_COLUMNS:
    rs2_frame_metadata_value = 100;
#[doc = "< Edge size of each tile, measured in cm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_OCCUPANCY_CELL_SIZE:
    rs2_frame_metadata_value = 101;
#[doc = "< The max number of points is 640x360"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_NUMBER_OF_3D_VERTICES:
    rs2_frame_metadata_value = 102;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_PRESET_ERROR_TYPE:
    rs2_frame_metadata_value = 103;
#[doc = "< Preset Error Param. Enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_PRESET_ERROR_PARAM_1:
    rs2_frame_metadata_value = 104;
#[doc = "< Preset Error Param. Enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_SAFETY_PRESET_ERROR_PARAM_2:
    rs2_frame_metadata_value = 105;
#[doc = "< Danger Zone point #0, X coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DANGER_ZONE_POINT_0_X_CORD:
    rs2_frame_metadata_value = 106;
#[doc = "< Danger Zone point #0, Y coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DANGER_ZONE_POINT_0_Y_CORD:
    rs2_frame_metadata_value = 107;
#[doc = "< Danger Zone point #1, X coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DANGER_ZONE_POINT_1_X_CORD:
    rs2_frame_metadata_value = 108;
#[doc = "< Danger Zone point #1, Y coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DANGER_ZONE_POINT_1_Y_CORD:
    rs2_frame_metadata_value = 109;
#[doc = "< Danger Zone point #2, X coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DANGER_ZONE_POINT_2_X_CORD:
    rs2_frame_metadata_value = 110;
#[doc = "< Danger Zone point #2, Y coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DANGER_ZONE_POINT_2_Y_CORD:
    rs2_frame_metadata_value = 111;
#[doc = "< Danger Zone point #3, X coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DANGER_ZONE_POINT_3_X_CORD:
    rs2_frame_metadata_value = 112;
#[doc = "< Danger Zone point #3, Y coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DANGER_ZONE_POINT_3_Y_CORD:
    rs2_frame_metadata_value = 113;
#[doc = "< Warning Zone point #0, X coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_WARNING_ZONE_POINT_0_X_CORD:
    rs2_frame_metadata_value = 114;
#[doc = "< Warning Zone point #0, Y coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_WARNING_ZONE_POINT_0_Y_CORD:
    rs2_frame_metadata_value = 115;
#[doc = "< Warning Zone point #1, X coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_WARNING_ZONE_POINT_1_X_CORD:
    rs2_frame_metadata_value = 116;
#[doc = "< Warning Zone point #1, Y coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_WARNING_ZONE_POINT_1_Y_CORD:
    rs2_frame_metadata_value = 117;
#[doc = "< Warning Zone point #2, X coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_WARNING_ZONE_POINT_2_X_CORD:
    rs2_frame_metadata_value = 118;
#[doc = "< Warning Zone point #2, Y coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_WARNING_ZONE_POINT_2_Y_CORD:
    rs2_frame_metadata_value = 119;
#[doc = "< Warning Zone point #3, X coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_WARNING_ZONE_POINT_3_X_CORD:
    rs2_frame_metadata_value = 120;
#[doc = "< Warning Zone point #3, Y coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_WARNING_ZONE_POINT_3_Y_CORD:
    rs2_frame_metadata_value = 121;
#[doc = "< Diagnostic Zone point #0, X coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DIAGNOSTIC_ZONE_POINT_0_X_CORD:
    rs2_frame_metadata_value = 122;
#[doc = "< Diagnostic Zone point #0, Y coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DIAGNOSTIC_ZONE_POINT_0_Y_CORD:
    rs2_frame_metadata_value = 123;
#[doc = "< Diagnostic Zone point #1, X coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DIAGNOSTIC_ZONE_POINT_1_X_CORD:
    rs2_frame_metadata_value = 124;
#[doc = "< Diagnostic Zone point #1, Y coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DIAGNOSTIC_ZONE_POINT_1_Y_CORD:
    rs2_frame_metadata_value = 125;
#[doc = "< Diagnostic Zone point #2, X coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DIAGNOSTIC_ZONE_POINT_2_X_CORD:
    rs2_frame_metadata_value = 126;
#[doc = "< Diagnostic Zone point #2, Y coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DIAGNOSTIC_ZONE_POINT_2_Y_CORD:
    rs2_frame_metadata_value = 127;
#[doc = "< Diagnostic Zone point #3, X coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DIAGNOSTIC_ZONE_POINT_3_X_CORD:
    rs2_frame_metadata_value = 128;
#[doc = "< Diagnostic Zone point #3, Y coord in mm"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_DIAGNOSTIC_ZONE_POINT_3_Y_CORD:
    rs2_frame_metadata_value = 129;
#[doc = "< Bitmask, enumerated"]
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_EMBEDDED_FILTERS: rs2_frame_metadata_value =
    130;
pub const rs2_frame_metadata_value_RS2_FRAME_METADATA_COUNT: rs2_frame_metadata_value = 131;
#[doc = " \\brief Per-Frame-Metadata is the set of read-only properties that might be exposed for each individual frame."]
pub type rs2_frame_metadata_value = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub type rs2_calib_target_type = ::std::os::raw::c_int;
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = " When called on Labeled Points frame type, this method returns a pointer to an array of 3D vertices of the model\n The coordinate system is: X right, Y up, Z away from the camera. Units: Meters\n \\param[in] frame       Labeled Points frame\n \\param[out] error      If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return                Pointer to an array of vertices, lifetime is managed by the frame"]
    pub fn rs2_get_frame_labeled_vertices(
        frame: *const rs2_frame,
        error: *mut *mut rs2_error,
    ) -> *mut rs2_vertex;
}
unsafe extern "C" {
    #[doc = " When called on Labeled Points frame type, this method returns the number of vertices in the frame\n \\param[in] frame       Labeled Points frame\n \\param[out] error      If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return                Number of vertices"]
    pub fn rs2_get_frame_labeled_points_count(
        frame: *const rs2_frame,
        error: *mut *mut rs2_error,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " When called on Labeled Points frame type, this method returns a pointer to an array of labels\n \\param[in] frame       Vertices frame\n \\param[out] error      If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return                Pointer to an array of attributes, lifetime is managed by the frame"]
    pub fn rs2_get_frame_labels(
        frame: *const rs2_frame,
        error: *mut *mut rs2_error,
    ) -> *mut ::std::os::raw::c_void;
}
unsafe extern "C" {
    #[doc = " retrieve labeled point cloud width in pixels\n \\param[in] frame      handle returned from a callback\n \\param[out] error     if non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return               frame width in pixels"]
    pub fn rs2_get_frame_labeled_points_width(
        frame: *const rs2_frame,
        error: *mut *mut rs2_error,
    ) -> ::std::os::raw::c_uint;
}
unsafe extern "C" {
    #[doc = " retrieve labeled point cloud height in pixels\n \\param[in] frame      handle returned from a callback\n \\param[out] error     if non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return               frame height in pixels"]
    pub fn rs2_get_frame_labeled_points_height(
        frame: *const rs2_frame,
        error: *mut *mut rs2_error,
    ) -> ::std::os::raw::c_uint;
}
unsafe extern "C" {
    #[doc = " retrieve bits per pixels in the labeled point cloud frame\n \\param[in] frame      handle returned from a callback\n \\param[out] error     if non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return               bits per pixel"]
    pub fn rs2_get_frame_labeled_points_bits_per_pixel(
        frame: *const rs2_frame,
        error: *mut *mut rs2_error,
    ) -> ::std::os::raw::c_uint;
}
...
unsafe extern "C" {
    #[doc = " When called on Object Detection frame type, this method returns the number of detections in the frame\n \\param[in] frame       Object Detection frame\n \\param[out] error      If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return                Number of detections"]
    pub fn rs2_get_frame_object_detection_count(
        frame: *const rs2_frame,
        error: *mut *mut rs2_error,
    ) -> ::std::os::raw::c_uint;
}
unsafe extern "C" {
    #[doc = " When called on Object Detection frame type, this method returns a specific detection by index\n \\param[in] frame       Object Detection frame\n \\param[in] index       Index of detection to retrieve\n \\param[out] detection  Pointer to struct to fill with detection data\n \\param[out] error      If non-null, receives any error that occurs during this call, otherwise, errors are ignored"]
    pub fn rs2_get_frame_object_detection(
        frame: *const rs2_frame,
        index: ::std::os::raw::c_uint,
        detection: *mut rs2_object_detection,
        error: *mut *mut rs2_error,
    );
}
...
#[doc = "< DEPRECATED! - The resolution mode: see rs2_sensor_mode for values"]
...
#[doc = "< The rectangular area used from the streaming profile"]
pub const rs2_option_RS2_OPTION_REGION_OF_INTEREST: rs2_option = 98;
pub const rs2_option_RS2_OPTION_ROTATION: rs2_option = 99;
#[doc = "< Set / Get current active safety preset index"]
pub const rs2_option_RS2_OPTION_SAFETY_PRESET_ACTIVE_INDEX: rs2_option = 100;
#[doc = "< Safety camera operation mode see rs2_safety_camera_mode for values"]
pub const rs2_option_RS2_OPTION_SAFETY_MODE: rs2_option = 101;
#[doc = "< RGB Temporal Noise Reduction enabling ON (1) / OFF (0)"]
pub const rs2_option_RS2_OPTION_RGB_TNR_ENABLED: rs2_option = 102;
#[doc = "< Temperature of the SMCU"]
pub const rs2_option_RS2_OPTION_SAFETY_MCU_TEMPERATURE: rs2_option = 103;
#[doc = "< Temperature of the Left IR Sensor"]
pub const rs2_option_RS2_OPTION_LEFT_IR_TEMPERATURE: rs2_option = 104;
#[doc = "< Enable/Disable Embedded Filter"]
pub const rs2_option_RS2_OPTION_EMBEDDED_FILTER_ENABLED: rs2_option = 105;
#[doc = "< Number of enumeration values. Not a valid input: intended to be used in for-loops."]
pub const rs2_option_RS2_OPTION_COUNT: rs2_option = 106;
...
pub type rs2_option = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub const rs2_option_type_RS2_OPTION_TYPE_RECT: rs2_option_type = 4;
pub const rs2_option_type_RS2_OPTION_TYPE_COUNT: rs2_option_type = 5;
#[doc = " \\brief Defines known option value types."]
pub type rs2_option_type = ::std::os::raw::c_int;
unsafe extern "C" {
...
#[doc = " A rectangle expressed in 64 bits, used with rs2_option_value::as_rect.\n Same semantics as rs2_set_region_of_interest."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rs2_option_rect {
    pub x1: i16,
    pub y1: i16,
    pub x2: i16,
    pub y2: i16,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_option_rect"][::std::mem::size_of::<rs2_option_rect>() - 8usize];
    ["Alignment of rs2_option_rect"][::std::mem::align_of::<rs2_option_rect>() - 2usize];
    ["Offset of field: rs2_option_rect::x1"][::std::mem::offset_of!(rs2_option_rect, x1) - 0usize];
    ["Offset of field: rs2_option_rect::y1"][::std::mem::offset_of!(rs2_option_rect, y1) - 2usize];
    ["Offset of field: rs2_option_rect::x2"][::std::mem::offset_of!(rs2_option_rect, x2) - 4usize];
    ["Offset of field: rs2_option_rect::y2"][::std::mem::offset_of!(rs2_option_rect, y2) - 6usize];
};
...
pub union rs2_option_value__bindgen_ty_1 {
    ...
    pub as_integer: i64,
    pub as_rect: rs2_option_rect,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_option_value__bindgen_ty_1"]
        [::std::mem::size_of::<rs2_option_value__bindgen_ty_1>() - 8usize];
    ["Alignment of rs2_option_value__bindgen_ty_1"]
        [::std::mem::align_of::<rs2_option_value__bindgen_ty_1>() - 1usize];
    ["Offset of field: rs2_option_value__bindgen_ty_1::as_string"]
        [::std::mem::offset_of!(rs2_option_value__bindgen_ty_1, as_string) - 0usize];
    ["Offset of field: rs2_option_value__bindgen_ty_1::as_float"]
        [::std::mem::offset_of!(rs2_option_value__bindgen_ty_1, as_float) - 0usize];
    ["Offset of field: rs2_option_value__bindgen_ty_1::as_integer"]
        [::std::mem::offset_of!(rs2_option_value__bindgen_ty_1, as_integer) - 0usize];
    ["Offset of field: rs2_option_value__bindgen_ty_1::as_rect"]
        [::std::mem::offset_of!(rs2_option_value__bindgen_ty_1, as_rect) - 0usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of rs2_option_value"][::std::mem::size_of::<rs2_option_value>() - 20usize];
    ["Alignment of rs2_option_value"][::std::mem::align_of::<rs2_option_value>() - 4usize];
    ["Offset of field: rs2_option_value::id"]
        [::std::mem::offset_of!(rs2_option_value, id) - 0usize];
    ["Offset of field: rs2_option_value::is_valid"]
        [::std::mem::offset_of!(rs2_option_value, is_valid) - 4usize];
    ["Offset of field: rs2_option_value::type_"]
        [::std::mem::offset_of!(rs2_option_value, type_) - 8usize];
};
...
pub type rs2_sr300_visual_preset = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub type rs2_rs400_visual_preset = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub type rs2_l500_visual_preset = ::std::os::raw::c_int;
unsafe extern "C" {
...
#[doc = " \\brief DEPRECATED! - For setting the camera_mode option"]
pub type rs2_sensor_mode = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub type rs2_ambient_light = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub type rs2_digital_gain = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub type rs2_host_perf_mode = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub type rs2_emitter_frequency_mode = ::std::os::raw::c_int;
unsafe extern "C" {
...
pub type rs2_depth_auto_exposure_mode = ::std::os::raw::c_int;
unsafe extern "C" {
    pub fn rs2_depth_auto_exposure_mode_to_string(
        mode: rs2_depth_auto_exposure_mode,
    ) -> *const ::std::os::raw::c_char;
}
pub const rs2_safety_mode_RS2_SAFETY_MODE_RUN: rs2_safety_mode = 0;
pub const rs2_safety_mode_RS2_SAFETY_MODE_STANDBY: rs2_safety_mode = 1;
pub const rs2_safety_mode_RS2_SAFETY_MODE_SERVICE: rs2_safety_mode = 2;
pub const rs2_safety_mode_RS2_SAFETY_MODE_COUNT: rs2_safety_mode = 3;
#[doc = " \\brief values for RS2_OPTION_SAFETY_MODE option."]
pub type rs2_safety_mode = ::std::os::raw::c_int;
unsafe extern "C" {
    pub fn rs2_safety_mode_to_string(mode: rs2_safety_mode) -> *const ::std::os::raw::c_char;
}
pub const rs2_d500_intercam_sync_mode_RS2_D500_INTERCAM_SYNC_NONE: rs2_d500_intercam_sync_mode = 0;
pub const rs2_d500_intercam_sync_mode_RS2_D500_INTERCAM_SYNC_RGB_MASTER:
    rs2_d500_intercam_sync_mode = 1;
pub const rs2_d500_intercam_sync_mode_RS2_D500_INTERCAM_SYNC_PWM_MASTER:
    rs2_d500_intercam_sync_mode = 2;
pub const rs2_d500_intercam_sync_mode_RS2_D500_INTERCAM_SYNC_EXTERNAL_MASTER:
    rs2_d500_intercam_sync_mode = 3;
pub const rs2_d500_intercam_sync_mode_RS2_D500_INTERCAM_SYNC_COUNT: rs2_d500_intercam_sync_mode = 4;
#[doc = " \\brief values for RS2_OPTION_INTER_CAM_SYNC_MODE option."]
pub type rs2_d500_intercam_sync_mode = ::std::os::raw::c_int;
unsafe extern "C" {
    pub fn rs2_d500_intercam_sync_mode_to_string(
        mode: rs2_d500_intercam_sync_mode,
    ) -> *const ::std::os::raw::c_char;
}
...
pub type rs2_gyro_sensitivity = ::std::os::raw::c_int;
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = " Creates post-processing filter block. This block accepts frames and applies rotation filter\n \\param[out] error  if non-null, receives any error that occurs during this call, otherwise, errors are ignored"]
    pub fn rs2_create_rotation_filter_block(
        streams_to_rotate: rs2_streams_list,
        error: *mut *mut rs2_error,
    ) -> *mut rs2_processing_block;
}
unsafe extern "C" {
...
pub type rs2_playback_status = ::std::os::raw::c_int;
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = " rs2_set_safety_preset\n \\param[in]  sensor        Safety sensor\n \\param[in]  index         Index to write to\n \\param[in]  sp_json_str   Safety preset as JSON string\n \\param[out] error         If non-null, receives any error that occurs during this call, otherwise, errors are ignored"]
    pub fn rs2_set_safety_preset(
        sensor: *const rs2_sensor,
        index: ::std::os::raw::c_int,
        sp_json_str: *const ::std::os::raw::c_char,
        error: *mut *mut rs2_error,
    );
}
unsafe extern "C" {
    #[doc = " rs2_get_safety_interface_config\n \\param[in]   sensor        Safety sensor\n \\param[out]  loc           Calibration location that needs to be read from\n \\param[out]  error         If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return                    JSON string representing the safety interface config as rs2_raw_data_buffer"]
    pub fn rs2_get_safety_interface_config(
        sensor: *const rs2_sensor,
        loc: rs2_calib_location,
        error: *mut *mut rs2_error,
    ) -> *const rs2_raw_data_buffer;
}
unsafe extern "C" {
    #[doc = " rs2_set_safety_interface_config\n \\param[in]  sensor          Safety sensor\n \\param[in]  sic_json_str    Safety interface config as JSON string\n \\param[out] error           If non-null, receives any error that occurs during this call, otherwise, errors are ignored"]
    pub fn rs2_set_safety_interface_config(
        sensor: *const rs2_sensor,
        sic_json_str: *const ::std::os::raw::c_char,
        error: *mut *mut rs2_error,
    );
}
unsafe extern "C" {
    #[doc = " rs2_get_application_config\n \\param[in]  sensor        Safety sensor\n \\param[out] error         If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return                   JSON string representing the application config as rs2_raw_data_buffer"]
    pub fn rs2_get_application_config(
        sensor: *const rs2_sensor,
        error: *mut *mut rs2_error,
    ) -> *const rs2_raw_data_buffer;
}
unsafe extern "C" {
    #[doc = " rs2_set_application_config\n \\param[in]  sensor                           Safety sensor\n \\param[in]  application_config_json_str      Application config as JSON string\n \\param[out] error                            If non-null, receives any error that occurs during this call, otherwise, errors are ignored"]
    pub fn rs2_set_application_config(
        sensor: *const rs2_sensor,
        application_config_json_str: *const ::std::os::raw::c_char,
        error: *mut *mut rs2_error,
    );
}
#[doc = "< Use USB connection only"]
pub const rs2_eth_link_priority_RS2_LINK_PRIORITY_USB_ONLY: rs2_eth_link_priority = 0;
#[doc = "< Use Ethernet connection only"]
pub const rs2_eth_link_priority_RS2_LINK_PRIORITY_ETH_ONLY: rs2_eth_link_priority = 1;
#[doc = "< Prefer Ethernet, fallback to USB"]
pub const rs2_eth_link_priority_RS2_LINK_PRIORITY_ETH_FIRST: rs2_eth_link_priority = 2;
#[doc = "< Prefer USB, fallback to Ethernet"]
pub const rs2_eth_link_priority_RS2_LINK_PRIORITY_USB_FIRST: rs2_eth_link_priority = 3;
#[doc = "< Dynamic switching bit flag"]
pub const rs2_eth_link_priority_RS2_LINK_PRIORITY_DYNAMIC_BIT: rs2_eth_link_priority = 16;
#[doc = "< Dynamic Ethernet-first priority"]
pub const rs2_eth_link_priority_RS2_LINK_PRIORITY_DYNAMIC_ETH_FIRST: rs2_eth_link_priority = 18;
#[doc = "< Dynamic USB-first priority"]
pub const rs2_eth_link_priority_RS2_LINK_PRIORITY_DYNAMIC_USB_FIRST: rs2_eth_link_priority = 19;
#[doc = "< Number of enumeration values. Not a valid input: intended to be used in for-loops."]
pub const rs2_eth_link_priority_RS2_LINK_PRIORITY_COUNT: rs2_eth_link_priority = 20;
#[doc = " \\brief Ethernet link priority options"]
pub type rs2_eth_link_priority = ::std::os::raw::c_int;
unsafe extern "C" {
    pub fn rs2_eth_link_priority_to_string(
        priority: rs2_eth_link_priority,
    ) -> *const ::std::os::raw::c_char;
}
#[doc = " \\brief IP address structure for IPv4 addresses"]
pub type rs2_ip_address = [u8; 4usize];
unsafe extern "C" {
    #[doc = " Check if device supports ethernet configuration\n \\param[in] device    RealSense device\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return              Non-zero if device supports ethernet configuration, zero otherwise"]
    pub fn rs2_supports_eth_config(
        device: *const rs2_device,
        error: *mut *mut rs2_error,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    #[doc = " Get Ethernet link speed\n \\param[in] device    RealSense device\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return              Current Ethernet link speed Mbps. 0 if link is not available."]
    pub fn rs2_get_link_speed(
        device: *const rs2_device,
        error: *mut *mut rs2_error,
    ) -> ::std::os::raw::c_uint;
}
unsafe extern "C" {
    #[doc = " Get link priority\n \\param[in] device    RealSense device\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return              Current link priority setting"]
    pub fn rs2_get_link_priority(
        device: *const rs2_device,
        error: *mut *mut rs2_error,
    ) -> rs2_eth_link_priority;
}
unsafe extern "C" {
    #[doc = " Set link priority\n \\param[in] device    RealSense device\n \\param[in] priority  Link priority to set\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored"]
    pub fn rs2_set_link_priority(
        device: *const rs2_device,
        priority: rs2_eth_link_priority,
        error: *mut *mut rs2_error,
    );
...
unsafe extern "C" {
    #[doc = " Get timeout in milliseconds before falling back to other connection type\n \\param[in] device    RealSense device\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return              Current link timeout in milliseconds"]
    pub fn rs2_get_link_timeout(
        device: *const rs2_device,
        error: *mut *mut rs2_error,
    ) -> ::std::os::raw::c_uint;
}
unsafe extern "C" {
    #[doc = " Set timeout in milliseconds before falling back to other connection type\n \\param[in] device    RealSense device\n \\param[in] timeout   Link timeout to set in milliseconds\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored"]
    pub fn rs2_set_link_timeout(
        device: *const rs2_device,
...
unsafe extern "C" {
    #[doc = " Get current DDS domain id (0-232) used when connected through Ethernet\n \\param[in] device    RealSense device\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return              Current DDS domain id used when connected through Ethernet"]
    pub fn rs2_get_dds_domain(
        device: *const rs2_device,
        error: *mut *mut rs2_error,
    ) -> ::std::os::raw::c_uint;
}
unsafe extern "C" {
    #[doc = " Set DDS domain id to use when connected through Ethernet\n \\param[in] device    RealSense device\n \\param[in] domain    DDS domain id to use (0-232)\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored"]
    pub fn rs2_set_dds_domain(
        device: *const rs2_device,
...
unsafe extern "C" {
    ...
    pub fn rs2_get_ip_address(
        device: *const rs2_device,
        configured_ip: *mut u8,
        actual_ip: *mut u8,
        error: *mut *mut rs2_error,
    );
}
...
unsafe extern "C" {
    #[doc = " Get MTU (Maximum Transmission Unit)\n \\param[in] device    RealSense device\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return              Current MTU in bytes"]
    pub fn rs2_get_mtu(
        device: *const rs2_device,
        error: *mut *mut rs2_error,
    ) -> ::std::os::raw::c_uint;
...
unsafe extern "C" {
    #[doc = " Get transmission delay\n \\param[in] device    RealSense device\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return              Current transmission delay in microseconds"]
    pub fn rs2_get_transmission_delay(
        device: *const rs2_device,
        error: *mut *mut rs2_error,
    ) -> ::std::os::raw::c_uint;
}
unsafe extern "C" {
    #[doc = " Set transmission delay\n \\param[in] device    RealSense device\n \\param[in] delay     Transmission delay in microseconds (0-144, in 3us steps)\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored"]
    pub fn rs2_set_transmission_delay(
        device: *const rs2_device,
...
unsafe extern "C" {
    #[doc = " Get UDP packet \"time to live\" (TTL)\n \\param[in] device    RealSense device\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return              Current UDP TTL value"]
    pub fn rs2_get_udp_ttl(
        device: *const rs2_device,
        error: *mut *mut rs2_error,
    ) -> ::std::os::raw::c_uint;
}
unsafe extern "C" {
    #[doc = " Set UDP packet \"time to live\" (TTL)\n \\param[in] device    RealSense device\n \\param[in] ttl       UDP TTL value (1-255)\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored"]
    pub fn rs2_set_udp_ttl(
        device: *const rs2_device,
...
unsafe extern "C" {
    #[doc = " Restores configuration to factory settings\n \\param[in] device    RealSense device\n \\param[out] error    If non-null, receives any error that occurs during this call, otherwise, errors are ignored\n \\return              Non-zero if device supports ethernet configuration, zero otherwise"]
    pub fn rs2_restore_default_eth_config(device: *const rs2_device, error: *mut *mut rs2_error);
}
unsafe extern "C" {
...
unsafe extern "C" {
    pub fn rs2_hw_monitor_get_opcode_string(
